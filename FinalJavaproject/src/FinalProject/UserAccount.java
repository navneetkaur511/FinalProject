...
public abstract class UserAccount
{
	...
	public static final int CHEQUING_ACCOUNT=2;
	...
	String generateUniqueAccountNumber()
	{
		...
		if(ds.isAccountNumberUnique(accountNum))
		{
			return accountNum;
		}
	...
	boolean transferMoney(UserAccount ac, double amount)
	{
		if(balance-amount<minBalance)
			return false;
